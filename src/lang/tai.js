...
export default function Strings() {
  return {
    ...
    aboutDesc1: `นำเสนอการต่อสู้ที่ฉูดฉาด กราฟิกที่โดดเด่น และโหมดเกมที่หลากหลาย ${config.appName} เป็นเกม RPG แฮ็คและสแลช F2P ที่รวดเร็วคุณภาพ AAA เกมแรกในบล็อกเชนที่เปิดตัวใน Ape Chain`,
    aboutDesc2:
